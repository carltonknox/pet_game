...
std::vector<Pet> generatePets()
{
    ...
    pets.push_back(Pet(4, "Catcus", "I don't reccomend petting it, but I can't stop you.", "CATcus1", "CATcus2", 8));
    pets.push_back(Pet(5, "CatGPT", "As an AI language model, I cannot form emotional attachment to stoopid hooman. Meow~", "CatGpt", "CatGpt", 7));
    ...
    pets.push_back(Pet(7, "CatBall", "Balled up", "CatBall1", "CatBall2", 0));
    ...
    pets.push_back(Pet(12, "CatBall", "its a cat, its a ball, its a catball", "CatBall11", "CatBall12", 3));
    ...
    pets.push_back(Pet(25, "FishCat", "Could it be a rare catch?! No. It's just a Catfish...", "FishCat1", "FishCat2", 4));
    ...
    pets.push_back(Pet(29, "FishCat", "You caught a rare fish! Actually, its just a catfish", "FishCat9", "FishCat10", 4));
