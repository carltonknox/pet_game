    ...
    : QWidget(parent), stackedWidget(stackedWidget), inventory(inventory)
{
    ...
    egg_count_label = new QLabel("Egg: 0", this);
    coin_count_label = new QLabel("Coin: 0", this);
    ...
    connect(timer, &QTimer::timeout, this, &Purchase::updateInventory);
    timer->start(50);
